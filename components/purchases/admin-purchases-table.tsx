          ...
          <div className="flex items-center justify-between">
            ...
            <span className="text-xs font-medium text-slate-600">
              {dateFormatter.format(
                new Date(selectedPurchase.dataCompra)
              )}
            </span>
          </div>
          <div className="mt-4 grid gap-4 md:grid-cols-2">
            ...
            <div className="space-y-1.5">
              ...
              <p className="font-semibold text-slate-900">
                ...
                {selectedPurchase.ticketDetails?.flightNumber
                  ? selectedPurchase.ticketDetails.flightNumber
                  : ""}
              </p>
            </div>
          ...
          <div className="grid gap-3">
            ...
            <div className="rounded-xl border border-white/60 bg-white/80 p-3">
              <p className="text-sm font-semibold text-slate-900">
                {selectedPurchase.user?.fullName ??
        ...
        <section className="rounded-2xl border border-amber-100 bg-amber-50/80 p-5">
          <div className="flex flex-wrap items-center justify-between gap-3">
            ...
            <Button
              ...
              disabled={saving || selectedPurchase.status === "EMITIDA"}
            >
              {saving ? (
                <Loader2 className="h-4 w-4 animate-spin" />
              ) : (
          ...
          <div className="space-y-3">
            <div className="flex flex-wrap items-center gap-3">
              <label
                ...
                htmlFor={`status-${selectedPurchase.id}`}
              >
                Status do pedido
              </label>
              <select
                ...
                value={statusDraft}
                onChange={(event) =>
                  setStatusDraft(event.target.value as typeof statusDraft)
                }
              >
                <option value="AGUARDANDO_EMISSAO">
                  Aguardando emissão
                </option>
        ...
        <section className="rounded-2xl border border-slate-200 bg-slate-50/80 p-5">
          ...
          <div className="mt-4 grid gap-4 md:grid-cols-2">
              ...
              <p className="text-base font-semibold text-slate-900">
                {
                  PAYMENT_STATUS_LABELS[
                    (selectedPurchase.payment?.status ??
                      "PENDENTE") as PaymentStatusValue
                  ]
                }
              </p>
            </div>
              ...
              <p className="text-base font-semibold text-slate-900">
                {selectedPurchase.payment
                  ? currencyFormatter.format(
                      selectedPurchase.payment.amount
                    )
                  : "—"}
              </p>
            </div>
            <div className="space-y-1.5">
              ...
              <p className="text-base font-semibold text-slate-900">
                {selectedPurchase.payment?.externalReference ??
                  "Não informado"}
              </p>
            </div>
            <div className="space-y-1.5">
        ...
        <section className="rounded-2xl border border-blue-100 bg-blue-50/70 p-5">
          <div className="flex flex-wrap items-center justify-between gap-3">
            ...
            <Button onClick={handleSaveEmission} disabled={saving}>
              {saving ? (
                ...
                "Salvar dados para emissão"
              )}
            </Button>
          </div>
          <div className="mt-4 grid gap-4 lg:grid-cols-2">
            <div className="space-y-3">
              <label className="text-[11px] font-semibold uppercase tracking-[0.2em] text-slate-600">
                Localizador (PNR)
              </label>
              <Input
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div className="space-y-3 rounded-xl border border-white/70 bg-white/80 p-4 shadow-inner">
              <p className="text-[11px] font-semibold uppercase tracking-[0.25em] text-slate-700">
                Ida *
              </p>
