...
export function DestinationCard({
  ...
  return (
    <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
      ...
      <DialogContent className="max-h-[90vh] w-full max-w-[min(95vw,1400px)] xl:max-w-[min(95vw,1680px)] 2xl:max-w-[min(90vw,1800px)] overflow-hidden rounded-[40px] border border-slate-200 bg-white p-0 text-slate-700 shadow-[0_50px_120px_-60px_rgba(14,165,233,0.35)]">
