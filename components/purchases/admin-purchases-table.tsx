                      ...
                      <div className="mt-4 w-full rounded-2xl border border-slate-200 bg-white/90 p-6 shadow-sm">
                        <div className="flex flex-wrap items-center justify-between gap-3 border-b border-slate-100 pb-5">
                          <div className="space-y-1">
                            <p className="text-xs font-bold uppercase tracking-[0.25em] text-slate-500">Detalhes da compra</p>
                            <h3 className="text-xl font-semibold text-slate-900">{selectedPurchase.package.name}</h3>
                        ...
                        <div className="mt-6 grid gap-6 xl:grid-cols-[1.05fr_0.95fr_1.05fr]">
                          <div className="space-y-5">
                            <section className="rounded-2xl border border-slate-200 bg-slate-50/60 p-5">
                              <div className="flex items-center justify-between">
                                <div>
                                  <p className="text-[11px] font-semibold uppercase tracking-[0.25em] text-slate-500">Dados da compra</p>
                                  <h4 className="text-lg font-semibold text-slate-900">Informações gerais</h4>
                                </div>
                                <span className="text-xs font-medium text-slate-600">{dateFormatter.format(new Date(selectedPurchase.dataCompra))}</span>
                              </div>
                              <div className="mt-4 grid gap-4 md:grid-cols-2">
                                ...
                                <div className="space-y-1.5">
                                  ...
                                  <p className="font-semibold text-slate-900">
                                    {selectedPurchase.ticketDetails?.airline ?? "—"} {selectedPurchase.ticketDetails?.flightNumber ? selectedPurchase.ticketDetails.flightNumber : ""}
                                  </p>
                                </div>
                                <div className="space-y-1.5">
                              ...
                              <div className="grid gap-3">
                                ...
                                <div className="rounded-xl border border-white/60 bg-white/80 p-3">
                                  <p className="text-sm font-semibold text-slate-900">{selectedPurchase.user?.fullName ?? selectedPurchase.user?.username ?? "Cliente"}</p>
                                  <p className="text-sm text-slate-600">{selectedPurchase.user?.email ?? "E-mail não informado"}</p>
                                </div>
                              </div>
                            </section>
                            ...
                            <section className="rounded-2xl border border-slate-200 bg-white p-5">
                              <div className="flex flex-wrap items-center justify-between gap-3">
                                <div>
                                  <p className="text-[11px] font-semibold uppercase tracking-[0.25em] text-slate-500">Passageiros vinculados</p>
                              ...
                              <div className="mt-4 space-y-4">
                                {passengerDrafts.map((passenger) => (
                                  <div key={passenger.id} className="space-y-3 rounded-xl border border-slate-100 bg-slate-50/70 p-4 shadow-inner">
                          ...
                          <div className="space-y-5">
                            <section className="rounded-2xl border border-amber-100 bg-amber-50/80 p-5">
                              <div className="flex flex-wrap items-center justify-between gap-3">
                                <div>
                                  <p className="text-[11px] font-semibold uppercase tracking-[0.25em] text-amber-700">Ações do pedido</p>
                            ...
                            <section className="rounded-2xl border border-slate-200 bg-slate-50/80 p-5">
                              ...
                              <div className="mt-4 grid gap-4 md:grid-cols-2">
                                ...
                                <div className="space-y-1.5">
                                  ...
                                  <p className="text-base font-semibold text-slate-900">{PAYMENT_STATUS_LABELS[(selectedPurchase.payment?.status ?? "PENDENTE") as PaymentStatusValue]}</p>
                                </div>
                                <div className="space-y-1.5">
                          ...
                          <div className="space-y-5">
                            <section className="rounded-2xl border border-blue-100 bg-blue-50/70 p-5">
                              <div className="flex flex-wrap items-center justify-between gap-3">
                                <div>
                                  <p className="text-[11px] font-semibold uppercase tracking-[0.25em] text-blue-700">Dados para emissão *</p>
